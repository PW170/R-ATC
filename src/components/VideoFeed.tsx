...
const VideoFeed = React.forwardRef<VideoFeedHandle, VideoFeedProps>(({ stream, onFrameCapture, interval, isActive }, ref) => {
  ...
  const captureFrame = () => {
    if (videoRef.current && canvasRef.current) {
      ...
      if (context && video.videoWidth > 0 && video.videoHeight > 0) {
        // Downscale logic (Increased for better clarity)
        ...
        // Convert to base64 PNG (Lossless for text clarity)
      ...
      {!stream && (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-aviation-500 bg-aviation-900/90 z-10">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mb-4 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a1 1 0 002 2z" />
          </svg>
